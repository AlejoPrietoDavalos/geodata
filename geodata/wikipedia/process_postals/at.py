...
def categorize_postal_code_at(postal_code_dirty: str) -> str | None:
...
def process_postal_code_at(postal_code_dirty: str) -> List[str] | None:
    category = categorize_postal_code_at(postal_code_dirty)
